...
def fuzzy_traffic_control(density, vehicle_counter):
    ...
    green_light_duration = ctrl.Consequent(np.arange(0, 71, 1), 'green_light_duration')
    ...
    green_light_duration['medium'] = fuzz.trimf(green_light_duration.universe, [0, 20, 40])
    green_light_duration['long'] = fuzz.trimf(green_light_duration.universe, [20, 40, 70])
...
def detect_objects(durasi, jalan_mana, emergency_cek, sudah_jalan1, sudah_jalan2, sudah_jalan3, sudah_jalan4):
    # Variable global
    ...
    while True:
        ...
        if (ret4):
            ...
            if frame_count4 % frame_interval == 0:
                # Perform object detection
                blob = cv2.dnn.blobFromImage(frame4, 1/255.0, (416, 416), swapRB=True, crop=False)
                net.setInput(blob)
                layer_names = net.getLayerNames()
                output_layers = [layer_names[i - 1] for i in net.getUnconnectedOutLayers()]
                outputs = net.forward(output_layers)
        ...
        if frame_count5 % frame_interval == 0:
            ...
            if elapsed_time >= durasi:
                if emergency_cek == 1:
                    ...
                    if sudah_jalan2:
                        if green_light_duration_3 > green_light_duration_4:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_3
                            density = density_3
                        ...
                        if green_light_duration_2 > green_light_duration_4:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_2
                            density = density_2
                        ...
                        if green_light_duration_2 > green_light_duration_3:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_3
                            density = density_3
                            green_light_duration = green_light_duration_3
                        ...
                        if green_light_duration_2 > green_light_duration_3 and green_light_duration_2 > green_light_duration_4:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_2
                            density = density_2
                            green_light_duration = green_light_duration_2
                            ...
                            # Geser ke video berikutnya
                            break
                        elif green_light_duration_3 > green_light_duration_2 and green_light_duration_3 > green_light_duration_4:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_3
                            density = density_3
                            green_light_duration = green_light_duration_3
                            ...
                            # Geser ke video berikutnya
                            break
                        elif green_light_duration_4 > green_light_duration_2 and green_light_duration_4 > green_light_duration_3:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_4
                            density = density_4
                            green_light_duration = green_light_duration_4
                    ...
                    if sudah_jalan1:
                        ...
                        if green_light_duration_1 > green_light_duration_4:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_1
                            density = density_1
                            green_light_duration = green_light_duration_1
                        ...
                        if green_light_duration_1 > green_light_duration_3:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_1
                            density = density_1
                            green_light_duration = green_light_duration_1
                        ...
                        if green_light_duration_1 > green_light_duration_3 and green_light_duration_1 > green_light_duration_4:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_1
                            density = density_1
                            green_light_duration = green_light_duration_1
                            ...
                            # Geser ke video berikutnya
                            break
                        elif green_light_duration_3 > green_light_duration_1 and green_light_duration_3 > green_light_duration_4:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_3
                            density = density_3
                            green_light_duration = green_light_duration_3
                            ...
                            # Geser ke video berikutnya
                            break
                        elif green_light_duration_4 > green_light_duration_1 and green_light_duration_4 > green_light_duration_3:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_4
                            density = density_4
                            green_light_duration = green_light_duration_4
                    ...
                    if sudah_jalan1:
                        ...
                        if green_light_duration_1 > green_light_duration_2:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_1
                            density = density_1
                            green_light_duration = green_light_duration_1
                        ...
                        if green_light_duration_1 > green_light_duration_2 and green_light_duration_1 > green_light_duration_4:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_1
                            density = density_1
                            green_light_duration = green_light_duration_1
                            ...
                            # Geser ke video berikutnya
                            break
                        elif green_light_duration_2 > green_light_duration_1 and green_light_duration_2 > green_light_duration_4:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_2
                            density = density_2
                            green_light_duration = green_light_duration_2
                            ...
                            # Geser ke video berikutnya
                            break
                        elif green_light_duration_4 > green_light_duration_1 and green_light_duration_4 > green_light_duration_2:
                            condition = "Normal"
                            vehicle_counter = vehicle_counter_4
                            density = density_4
                            green_light_duration = green_light_duration_4
...
def run_detection(durasi, jalan_mana, emergency_cek, sudah_jalan1, sudah_jalan2, sudah_jalan3, sudah_jalan4):
    global density, condition, vehicle_counter, green_light_duration, status_jalan
    condition, density, vehicle_counter, green_light_duration, status_jalan = detect_objects(durasi, jalan_mana, emergency_cek, sudah_jalan1, sudah_jalan2, sudah_jalan3, sudah_jalan4)
...
def pygame_simulasi():
    ...
    while running:
        ...
        if type(jalan1) == int and type(jalan4) == str:
            ...
            if perform_detection and type(jalan2) == str:
                ...
                if jalan1 == 0 and status == 1:
                    ...
                    detection_thread = threading.Thread(target=run_detection, args=(durasi, jalan_mana, emergency_cek, sudah_jalan1, sudah_jalan2, sudah_jalan3, sudah_jalan4))
            ...
            if jalan1 == 0 and status == 1:
                ...
                if jalan1 == 0 and jalan2 == 0 and status == 1:
                    jalan1 = lampu_hijau
                    jalan2 = "---"
                    text_jalan2 = font.render(str(jalan2), True, (255, 255, 255))
                    screen.blit(text_jalan2, (325, 430))
                elif jalan1 == 0 and jalan2 == 0 and status == 2:
                    jalan1 = '---'
                    jalan2 = lampu_hijau
            ...
            if jalan2 == 0 and status == 2:
                ...
                if jalan2 == 0 and jalan3 == 0 and status == 2:
                    jalan2 = lampu_hijau
                    jalan3 = "---"
                    text_jalan3 = font.render(str(jalan3), True, (255, 255, 255))
                    screen.blit(text_jalan3, (630, 430))
                elif jalan2 == 0 and jalan3 == 0 and status == 3:
                    jalan2 = '---'
                    jalan3 = lampu_hijau
            ...
            if jalan3 == 0 and status == 3:
                ...
                if jalan3 == 0 and jalan4 == 0 and status == 3:
                    jalan3 = lampu_hijau
                    jalan4 = "---"
                    text_merah = font.render(str(jalan4), True, (255, 255, 255))
                    screen.blit(text_merah, (365, 130))
                ...
                elif jalan3 == 0 and jalan4 == 0 and status == 4:
            ...
            if jalan4 == 0 and status == 4:
                ...
                if jalan4 == 0 and jalan1 == 0 and status == 4:
                    jalan4 = lampu_hijau
                    jalan1 = "---"
                    text_merah = font.render(str(jalan1), True, (255, 255, 255))
                    screen.blit(text_merah, (365, 130)) 
                    
                elif jalan4 == 0 and jalan1 == 0 and status == 1:
        ...
        if  sudah_jalan1 and sudah_jalan2 and sudah_jalan3 and sudah_jalan4:
            sudah_jalan1 = False
            sudah_jalan2 = False
            sudah_jalan3 = False
            sudah_jalan4 = False
...
if __name__ == '__main__':  
    ...
    video_path = [
                'C:/Users/Acer/yolov4/video/Untitled video - Made with Clipchamp (6).mp4',
                'C:/Users/Acer/yolov4/video/video16.mp4',
                'C:/Users/Acer/yolov4/video/video20.mp4',
                'C:/Users/Acer/yolov4/video/video17.mp4',
                
                'C:/Users/Acer/yolov4/video/video19.mp4',
                'C:/Users/Acer/yolov4/video/video20.mp4', 
                'C:/Users/Acer/yolov4/video/video10.mp4',
                'C:/Users/Acer/yolov4/video/video9.mp4'
    ...
    if cv2.waitKey(1) == ord('q'):
        ...
        #'C:/Users/Acer/yolov4/video/video9.mp4', 
        #'C:/Users/Acer/yolov4/video/video10.mp4',
        #'C:/Users/Acer/yolov4/video/video13.mp4',
        
        #'C:/Users/Acer/yolov4/video/video12.mp4',
        #'C:/Users/Acer/yolov4/video/video20.mp4',
        #'C:/Users/Acer/yolov4/video/video11.mp4',
        #'C:/Users/Acer/yolov4/video/video14.mp4',
        
        #'C:/Users/Acer/yolov4/video/video15.mp4',
        #'C:/Users/Acer/yolov4/video/video16_lama.mp4', 
        #'C:/Users/Acer/yolov4/video/video17.mp4',
        #'C:/Users/Acer/yolov4/video/video18.mp4'"""
