...
def detect_objects(durasi, jalan_mana, cek_status):
    # Variable global
...
def run_detection(durasi, jalan_mana, cek_status):
    global density, condition, vehicle_counter, green_light_duration, status_jalan
    condition, density, vehicle_counter, green_light_duration, status_jalan = detect_objects(durasi, jalan_mana, cek_status,)
    ...
    while running:
        ...
        if type(jalan1) == int and jalan1 > 0 and type(jalan4) == str:
            ...
            if perform_detection and type(jalan2) == str:
                ...
                detection_thread = threading.Thread(target=run_detection, args=(durasi, jalan_mana, cek_status,))
