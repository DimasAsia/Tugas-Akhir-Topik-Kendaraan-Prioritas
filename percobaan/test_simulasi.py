...
def detect_objects(video_path):
    ...
    video_seconds = int(duration)  # Get the duration of the video in seconds
    ...
    #inisialisasi awal
    durasi = 7
    test = 7 # Decrease test based on the number of seconds in the video
    ...
    while elapsed_time < duration:
        ...
        # Decrease the test variable every 30 frames
        frame_counter += 1
        if frame_counter >= 30:
            test -= 1
            frame_counter = 0
...
if __name__ == '__main__':
    ...
    density, condition, vehicle_counter, green_light_duration = detect_objects(video_path[index_path])
