...
path_to_images = 'C:/Users/Acer/yolov4/test/image'
ground_truth_folder = 'C:/Users/Acer/yolov4/test/truth_label'
...
# Create empty list for storing accuracy values
accuracies = []
...
for image_file in image_files:
    ...
    # Calculate overall accuracy for the current image
    image_accuracy = accuracy_score(y_true, y_pred)

    # Append the accuracy to the list
    accuracies.append(image_accuracy)
