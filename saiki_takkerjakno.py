...
def fuzzy_traffic_control(density, vehicle_counter):
    ...
    green_light_duration['long'] = fuzz.trimf(green_light_duration.universe, [10, 40, 70])
    ...
    rule5 = ctrl.Rule(density_level['Medium'] & vehicle_count_level['few'], green_light_duration['short'])
